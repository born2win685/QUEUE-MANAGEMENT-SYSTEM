...
def cancel_q():
  ...
  if (finalhour < 10):
    if (finalminute < 10):
      ...
      l6 = tk.Label(nww, text="Expected Arrival Time : " + "0" + str(finalhour) + ":" + str(finalminute) + " " + string,
                    font=("Times New Roman", 12), bg="white").place(x=60, y=130)

  else:
    if (finalminute < 10):
      l6 = tk.Label(nww, text="Expected Arrival Time : " + str(finalhour) + ":0" + str(finalminute) + " " + string,
                    font=("Times New Roman", 12), bg="white").place(x=60, y=130)
    else:
      l6 = tk.Label(nww, text="Expected Arrival Time : " + str(finalhour) + ":" + str(finalminute) + " " + string,
                    font=("Times New Roman", 12), bg="white").place(x=60, y=130)
